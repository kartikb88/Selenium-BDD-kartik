package com.kb.test.step_definitions.gui.register;


import com.kb.test.enums.PermittedCharacters;
import com.kb.test.framework.helpers.utils.RandomGenerator;
import com.kb.test.page_objects.gui.NewRegistrationPage;
